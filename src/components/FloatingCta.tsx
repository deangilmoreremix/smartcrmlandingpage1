...
const FloatingCta: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const calculateTimeLeft = () => {
      ...
      const difference = SALE_END_DATE.getTime() - now;
  ...
  useEffect(() => {
    // Simulate licenses decreasing and recent purchases
    const spotsInterval = setInterval(() => {
      setSpotsLeft(prev => {
        const newSpots = prev - 1;
        if (newSpots <= 15) return prev;
        setRecentSignups(Math.floor(Math.random() * 2) + 1);
        return newSpots;
      });
          ...
          <div className={`bg-gradient-to-br ${urgencyColor} text-white rounded-2xl shadow-2xl overflow-hidden relative`}>
            ...
            <div className="p-5 pt-12 relative z-[1]">
              ...
              <AnimatePresence>
                {recentSignups > 0 && (
                  ...
                  >
                    ...
                    {recentSignups} {recentSignups === 1 ? 'person' : 'people'} just purchased
                  </motion.div>
                )}
              </AnimatePresence>
              ...
              <p className="text-white/90 text-sm mb-3">
                AI-powered sales automation that transforms your business. Start closing more deals with less manual work.
              </p>
              ...
              <div className="space-y-2 mb-4">
                ...
                <div className="flex items-start text-xs">
                  ...
                  <span className="text-white/90">AI-powered deal scoring & forecasting</span>
                </div>
                <div className="flex items-start text-xs">
                  <Gift size={14} className="mr-2 mt-0.5 text-pink-300 flex-shrink-0" />
                  <span className="text-white/90">Free 3-day masterclass included</span>
                </div>
              </div>
                    ...
                    <div className="bg-white/10 rounded-lg p-3 space-y-2">
                      ...
                      <div className="space-y-1.5 text-xs text-white/80">
                        <div className="flex items-start">
                          ...
                          <span>GPT-5 powered AI analytics dashboard</span>
                        </div>
                        <div className="flex items-start">
                          <Award size={12} className="mr-2 mt-0.5 flex-shrink-0" />
                          <span>Intelligent contact & deal management</span>
                        </div>
                        <div className="flex items-start">
                          <Award size={12} className="mr-2 mt-0.5 flex-shrink-0" />
                          <span>Automated email & proposal generation</span>
                        </div>
                        <div className="flex items-start">
                          <Award size={12} className="mr-2 mt-0.5 flex-shrink-0" />
                          <span>40+ AI business tools & integrations</span>
                        </div>
                      </div>
                      ...
                      <div className="pt-2 border-t border-white/20">
                        <div className="flex items-center justify-between text-sm font-bold">
                          ...
                          <span className="text-green-300">Only $97</span>
                        </div>
              ...
              <div className="mb-4">
                <div className="flex items-center justify-between text-xs mb-1">
                  <span className="text-white/70">Licenses remaining:</span>
                  <motion.span
                    className="font-bold"
