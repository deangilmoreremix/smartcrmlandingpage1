...
const SignupFormSection: React.FC<SignupFormSectionProps> = ({
  ...
  subtitle = "Join us on October 17, 2025 at 3:00 PM EST for an exclusive demonstration of Smart CRM's AI-powered features."
}) => {
            ...
            <div className={`${formSubmitted ? 'lg:col-span-2 max-w-2xl mx-auto text-center' : ''}`}>
              <div className="text-center lg:text-left mb-8">
                ...
                <p className="text-xl text-white/80">
                  <span className="text-blue-400 font-medium">Free webinar</span> — October 17, 2025 at 3:00 PM EST
                </p>
              </div>
