/*
  # Remove size restrictions for webinar uploads

  1. Configuration Updates
    - Removes file size limit from webinar-videos bucket
    - Ensures any user can upload without size restrictions
    - Updates RLS policies to prevent permission issues
*/
